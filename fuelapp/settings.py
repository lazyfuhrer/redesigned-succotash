...
SHORT_IO_BASE_URL=env('SHORT_IO_BASE_URL')
SHORT_IO_PAY_API_KEY=env('SHORT_IO_PAY_API_KEY')
SHORT_IO_PAY_DOMAIN=env('SHORT_IO_PAY_DOMAIN')
...
# PHONEPE_PAYLINK_BASE_URL = env('PHONEPE_PAYLINK_BASE_URL')
